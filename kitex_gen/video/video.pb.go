...
type Video struct {
	...
	AuthorId      int64  `protobuf:"varint,2,opt,name=authorId,proto3" json:"authorId,omitempty"`                                // 视频作者信息
...
var file_video_proto_rawDesc = []byte{
	...
	0x22, 0xee, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x65, 0x22, 0x44, 0x0a, 0x0b, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x98, 0x01, 0x0a, 0x0c, 0x46, 0x65, 0x65, 0x64,
	...
	0x6d, 0x65, 0x22, 0x56, 0x0a, 0x14, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x41, 0x63, 0x74,
	...
	0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xd1, 0x01,
	...
	0x65, 0x42, 0x1b, 0x5a, 0x19, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x5f, 0x76, 0x32, 0x2f, 0x6b,
...
var file_video_proto_depIdxs = []int32{
	...
	0, // 1: video.PublishListResponse.video_list:type_name -> video.Video
	1, // 2: video.VideoService.Feed:input_type -> video.FeedRequest
	3, // 3: video.VideoService.PublishAction:input_type -> video.PublishActionRequest
	5, // 4: video.VideoService.PublishList:input_type -> video.PublishListRequest
	2, // 5: video.VideoService.Feed:output_type -> video.FeedResponse
	4, // 6: video.VideoService.PublishAction:output_type -> video.PublishActionResponse
	6, // 7: video.VideoService.PublishList:output_type -> video.PublishListResponse
